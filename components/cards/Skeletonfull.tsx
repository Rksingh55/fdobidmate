...
function Skelotonfull() {
    return (
        <div>
            <div
                className="mp-4 border border-gray-200 rounded  animate-pulse md:p-5 dark:border-gray-400"
            >
                ...
                <div
                    className="flex  mt-4 items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-400"
                >
                    <svg
                        viewBox="0 0 16 20"
                        fill="currentColor"
