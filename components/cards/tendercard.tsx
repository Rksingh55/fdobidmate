     ...
     <>
        <div className={`${view === 'grid' ? 'w-full  ' : 'w-full'} `}>
            <div className="  mt-2  border-2 rounded-md  bg-white border-[#FC8404]  relative md:p-9 p-3  hover:shadow-md">
                ...
                <p className='py-2 flex gap-2'><TenderidIcon/><strong>Tender ID :</strong> {tender.id}</p>
                ...
                <div className={`${view === 'grid' ? 'flex flex-wrap justify-between gap-3 py-2' : 'flex justify-between max-sm:flex-col max-sm:gap-2 py-2'} `} >
                    <div>
                        <p className='flex gap-1 font-bold text-[#4b4949]' ><span className='text-[#00A9E2] font-bold'><MdOutlineDateRange className=' text-lg' /> </span> {tender.startDate}</p>
                    </div>
                    <div>
                        <p className='flex gap-1 font-bold text-[#4b4949]' ><span className='text-[#00A9E2] font-bold'><MdOutlineDateRange className=' text-lg' /> </span>{tender.endDate}</p>
                    </div>
                    <div>
                        <p className='flex gap-1 font-bold text-[#4b4949]' ><span className='text-[#00A9E2] font-bold'><HiLocationMarker className=' text-lg' /> </span>{tender.region}</p>
                    </div>
                    <div>
                        <p className='flex gap-1 font-bold text-[#4b4949]' ><span className='text-[#00A9E2] font-bold'><BiSolidPurchaseTag className=' text-lg' /> </span>{tender.amount}</p>
                    </div>
                    <div>
                        <p className='flex gap-1 font-bold text-[#4b4949]' ><span className='text-[#00A9E2] font-bold'><GiDatabase className=' text-lg' /> </span>{tender.entity}</p>
                    </div>
                    <div>
